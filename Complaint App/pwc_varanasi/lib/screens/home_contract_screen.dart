...
import 'package:pwc_varanasi/fragments/complaints_contract_fragment.dart';
...
class HomeContractScreen extends StatefulWidget {
  const HomeContractScreen({super.key});

  @override
  State<HomeContractScreen> createState() => _HomeContractScreenState();
}

class _HomeContractScreenState extends State<HomeContractScreen> {
  int _currentIndex = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          Container(child: [
            ComplaintsContactFragment(screen: 0,),
            ProfileFragment(),
          ][_currentIndex]),
          Align(
