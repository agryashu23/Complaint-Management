...
import 'package:pwc_varanasi/screens/select_location.dart';
...
class Address {
  ...
  Address({required this.formattedAddress, required this.city, required this.state});
}

class CreateComplainScreen extends StatefulWidget {
  @override
  _CreateComplainScreenState createState() => _CreateComplainScreenState();
}
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  //         child: InkWell(
                  //           onTap: () async {
                  //             await Navigator.push(context, MaterialPageRoute(builder: (context)=>SelectLocation()));
                  //           },
                  //           borderRadius: BorderRadius.circular(20.0),
                  //           child: Container(
                  //             padding: EdgeInsets.all(10.0),
              ...
              child: Material(
                ...
                child: Ink(
                  ...
                  child: TextFormField(
                    ...
                    maxLines: 10,
                    decoration: InputDecoration(
                      labelText: 'Please explain the issue in details.',
                      prefixIcon: Icon(
            ...
            SizedBox(height: 5,),
            _selectedImages.length > 0 ? Padding(
