...
import 'package:pwc_varanasi/screens/resolve_complain_screen.dart';
import 'package:pwc_varanasi/screens/verify_complain_screen.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:url_launcher/url_launcher.dart';

import '../fragments/pending_complaints_contract_fragment.dart';

class ComplaintDetailContractScreen extends StatefulWidget {
  final Complaint complaint;
  ComplaintDetailContractScreen(this.complaint);

  @override
  _ComplaintDetailContractScreenState createState() => _ComplaintDetailContractScreenState();
}

class _ComplaintDetailContractScreenState extends State<ComplaintDetailContractScreen> {
                      ...
                      child: isRegistering
                          ...
                          : Material(
                              ...
                              child: Ink(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    Navigator.push(context, MaterialPageRoute(builder: (context)=>ResolveComplainScreen(widget.complaint)));
                                  },
                                  borderRadius: BorderRadius.circular(20.0),
                                  child: Container(
