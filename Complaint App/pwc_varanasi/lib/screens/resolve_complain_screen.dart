...
class ResolveComplainScreen extends StatefulWidget {
  final Complaint complaint;

  ResolveComplainScreen(this.complaint);

  @override
  _ResolveComplainScreenState createState() => _ResolveComplainScreenState();
}

class _ResolveComplainScreenState extends State<ResolveComplainScreen> {
  ...
  Future<void> uploadImagesToServer() async {
    ...
    final url = 'http://143.110.177.156:3000/mobile/repaired-complaints';
                ...
                child: Ink(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      labelText: 'Please add details about the repair.',
                      prefixIcon: Icon(
