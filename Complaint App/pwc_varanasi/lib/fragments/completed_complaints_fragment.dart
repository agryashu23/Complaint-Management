...
class CompletedComplaintsFragment extends StatefulWidget {
  const CompletedComplaintsFragment({super.key});

  @override
  State<CompletedComplaintsFragment> createState() => _CompletedComplaintsFragmentState();
}

class _CompletedComplaintsFragmentState extends State<CompletedComplaintsFragment> {
